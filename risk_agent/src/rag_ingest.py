...
def build_vector_store():
    scope_md = read_file(os.path.join(DOCS_DIR, "scope_doc.md"))
    req_md   = read_file(os.path.join(DOCS_DIR, "req_doc.md"))
    risk_md  = read_file(os.path.join(DOCS_DIR, "risk_doc.md"))
